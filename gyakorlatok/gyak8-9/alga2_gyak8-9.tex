...
\tikzset{
  ...
  arn_n/.style = {treenode, white, font=\sffamily\bfseries, draw=black, fill=black},% arbre rouge noir, noeud noir
  arn_r/.style = {treenode, red, draw=red, very thick},% arbre rouge noir, noeud rouge
