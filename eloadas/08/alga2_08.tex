...
$T=[t_0 t_1 \ldots t_n]$ input tartalmazza-e a $P=[p_0 p_1 \ldots p_m]$ 
...
\begin{frame}{Mintaillesztés véges állapotú automatákkal}
 \begin{itemize}
	...
	\item $q_m$ állapotba elérve elmondható, hogy megtaláltuk a $P=[p_0 p_1 
	\ldots p_m]$ minta egy $T$-beli előfordulását
 \end{itemize}
\end{frame}
