...
\begin{frame}{Összegzés}
	\begin{itemize}
		\item Változatos kiegészítő információk adhatók (pl.~mutató is lehet)
		\item Az addicionális adattagok újfajta kérdések hatékony megválaszolásához segíthetnek hozzá
		\item Fontos, hogy a kiegészítő információ aktualizálásra kerüljön
	\end{itemize}
\end{frame}
