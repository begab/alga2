...
\begin{frame}{Gyakorlati követelmények}
	\begin{itemize}
		\item 2 db ZH (márc.~18. és máj.~6.): 40-40 pont (min.~16 pont/ZH)
		\item Kvízek: 4 darab 5-5 pontos Coospace kvíz (min.~2 pont/kvíz)
		\item Pluszpontok (minimumba nem számítanak bele)
		\item Javítás: a rosszabbul sikerült ZH javítható az utolsó előadáson
	\end{itemize}
	\pause
	\begin{table}
	\centering
...
%\textcolor{blue}{ápr.~16, ápr.~30}
		\item Beadási határidő: \textcolor{red}{márc.~15.}, 
		\textcolor{blue}{máj.~3.} 23:59:59ig
