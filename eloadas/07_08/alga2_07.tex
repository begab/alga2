...
\begin{itemize}
	\item Keressük meg azt a félteret, ahova a lekérdezett pont esik
	\item A már megtalált legkisebb távolság alapján sok részfa vizsgálata 
	kiküszöbölhető
\end{itemize}
\end{frame}
