...
\includegraphics[width=\linewidth]{2D_ConvexHull}
	...
	\end{column}
\end{columns}
\begin{block}{CH gyakorlati felhasználása}
Objektumok ütközésének elkerülése, gépi tanulás (klaszterezés), \ldots
\end{block}
\end{frame}
...
\begin{comment}
\begin{frame}{Legközelebbi szomszéd meghatározása}
\begin{block}{Probléma}
	Adott ponthoz találjuk meg a hozzá legközelebb eső pontot
\end{block}
\begin{block}{Felhasználása}
	k-legközelebbi osztályozó, klaszterező eljárások
\end{block}
\begin{block}{k-d fák}
...
\begin{itemize}
	\item A geometriai algoritmusok számos gyakorlati probléma megoldása során 
	felmerülnek
